...
<form action="{{ url('products/updates') }}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select name="category" class="form-control">
                    ...
                    <option {{@old('category')==$cat->id || (isset($product->category_id) && $product->category_id==$cat->id )?'selected="selected"':''}} value="{{$cat->id}}">{{$cat->product_category}}</option>
                    @endforeach
                </select>
            </div>
        </div>
